V1Switch ( FabricParser ( ) , FabricVerifyChecksum ( ) , FabricIngress ( ) , FabricEgress ( ) , FabricComputeChecksum ( ) , FabricDeparser ( ) ) main;
 ...
 apply\{
 _PRE_EGRESS pkt_io_egress.apply ( hdr , fabric_metadata , standard_metadata );
...
\}
 ...
 Next ( ) next;
 apply\{
 _PRE_INGRESS pkt_io_ingress.apply ( hdr , fabric_metadata , standard_metadata );
...
\}
 extern packet_out\{
;
 \< T \> ( in T hdr ) void emit V1Switch ( FabricParser ( ) , FabricVerifyChecksum ( ) , FabricIngress ( ) , FabricEgress ( ) , FabricComputeChecksum ( ) , FabricDeparser ( ) ) main;
 control FabricEgress ( inout parsed_headers_t hdr , inout fabric_metadata_t fabric_metadata , inout standard_metadata_t standard_metadata )\{
 PacketIoEgress ( ) pkt_io_egress;
 EgressNextControl ( ) egress_next;
 apply\{
